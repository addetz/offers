...
/**
 * Test class for {@link CancelOfferRoute}.
 */
public class TestCancelOfferRoute {
    ...
    private CancelOfferRoute cancelOfferRoute;
    ...
    public void setUp() {
        ...
        cancelOfferRoute = new CancelOfferRoute();
    }
    ...
    public void testAlphabeticOfferId() {
        ...
        OfferResponse handleResponse = new Gson().fromJson(cancelOfferRoute.handle(request, response).toString(), OfferResponse.class);
    ...
    public void testValidOfferId() {
        ...
        assertEquals("The offer should now have been cancelled.", OfferStatus.CANCELLED,
                offer.get().getOfferDetail().getStatus());
    }
